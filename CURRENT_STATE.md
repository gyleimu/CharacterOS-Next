...
Last verified against commit: `975150b00aa1e254ec34794e5a7c5b3b22480072`（干净 baseline；`CHARACTEROS_PRODUCT_TURN_BUDGET_AND_LATENCY_EXPECTATION_V0` 是其直接子提交。§2 的机器派生计数仍以 `d4503cc` 为准，未在本 slice 重新测量）
