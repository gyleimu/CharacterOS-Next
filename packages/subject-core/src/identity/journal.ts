...
import type { AtomicCommitBundleAnyStateVersionV0 } from "../types/persistence-v2.js";
...
export interface TransitionIdentityJournalPort {
  ...
  rebuildFromCommittedBundles(bundles: readonly AtomicCommitBundleAnyStateVersionV0[]): void;
