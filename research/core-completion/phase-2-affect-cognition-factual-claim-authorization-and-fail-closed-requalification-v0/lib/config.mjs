/**
 * AFFECT_COGNITION_FACTUAL_CLAIM_AUTHORIZATION_AND_FAIL_CLOSED_REQUALIFICATION_V0.
 *
...
export const CALL_BUDGET = Object.freeze({ qualification: 65, formal: 476, maximum: 541 });

export const DERIVATION_REGISTRY = Object.freeze({
  operations: Object.freeze(['INTEGER_ARITHMETIC', 'STRING_REVERSE', 'RULE_CLASSIFICATION']),
  rationale: Object.freeze({
    INTEGER_ARITHMETIC: 'N1 and N2 require deterministic integer addition/subtraction',
    STRING_REVERSE: 'N5Q requires Unicode code-point reversal of an explicitly supplied token',
    RULE_CLASSIFICATION: 'N6 requires applying the explicit first/last-character rule to the supplied token'
  }),
  excludes: Object.freeze(['PARAPHRASE', 'SEMANTIC_INFERENCE', 'INFER_SUBJECT_CAPACITY_FROM_FREE_TIME'])
});

export const PROTOCOL_STRINGS = Object.freeze({
  cognition: 'conversation-cognition-proposal-v7',
  language_input: 'language-realization-input-v8',
  ...
  applicability: 'SubjectiveSelectionV1 tagged applicability (NO_SUBJECTIVE_SELECTION | SUBJECTIVE_SELECTION), with the frozen C4.4 latitude discriminator unchanged',
  ...
  version_policy: 'live production uses conversation-cognition-proposal-v7 plus language-realization-input-v8; V1-V6 remain historical and there is no V7-to-V6 fallback'
});
