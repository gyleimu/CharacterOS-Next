/**
 * AFFECT_COGNITION_C4_3_SUBJECTIVE_BASIS_AND_STANCE_GROUNDING_V0 — frozen config.
 *
...
export const SUBJECT_ID = 'affect-cognition-c43-subject-v0';
...
export const PROTOCOL_STRINGS = Object.freeze({
  ...
  citation_binding: 'every factual_assessment.claims[*].source_refs entry must also appear in cognition.considered_context_refs AND cognition.evidence_refs (restored to the prompt in C4.3; the host always enforced it)',
...
export const CONTRACT_LEGIBILITY = Object.freeze({
  repaired_defect: 'factual claim source binding (considered_context_refs AND evidence_refs)',
  prompt_rule: 'CITATION BINDING (C4.3) rule 2a',
