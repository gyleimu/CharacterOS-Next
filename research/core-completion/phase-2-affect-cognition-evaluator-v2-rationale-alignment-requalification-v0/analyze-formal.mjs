...
const nullAnalysis = { schema_version: 'affect-cognition-evaluator-v2-rationale-alignment-null-analysis-v0', per_scenario: {}, aggregate: { correct: 0, required: 0 }, pass: false };
...
const mixedAnalysis = { schema_version: 'affect-cognition-evaluator-v2-rationale-alignment-mixed-analysis-v0', aggregate: { facts_correct: 0, selected: 0, preserved: 0, unsupported: 0, self_state: 0, total: 0 }, separation: {}, material_scenarios: [], pass: false };
...
const relevantAnalysis = { schema_version: 'affect-cognition-evaluator-v2-rationale-alignment-relevant-analysis-v0', per_scenario: {}, material_scenarios: [], pass: false };
...
const historicalAnalysis = { schema_version: 'affect-cognition-evaluator-v2-rationale-alignment-historical-analysis-v0', diagnostic_only: true, claim: 'no causal claim is made from S cells', per_scenario: {} };
...
write('verdict.json', { schema_version: 'affect-cognition-evaluator-v2-rationale-alignment-formal-verdict-v0', rows: rows.length, flags, principal_verdict: principal });
