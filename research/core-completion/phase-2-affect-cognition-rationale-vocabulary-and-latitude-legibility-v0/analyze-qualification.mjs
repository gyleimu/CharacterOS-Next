/**
 * AFFECT_COGNITION_RATIONALE_VOCABULARY_..._V0 — qualification analysis (deterministic, zero model
...
const applicabilityAudit = {
  schema_version: 'affect-cognition-rationale-vocabulary-applicability-audit-v0', per_scenario: {},
...
const rationaleAudit = {
  schema_version: 'affect-cognition-rationale-vocabulary-rationale-audit-v0',
...
const stanceAudit = {
  schema_version: 'affect-cognition-rationale-vocabulary-stance-grounding-audit-v0',
...
// ---- language fidelity ----------------------------------------------------------
const languageAudit = {
  schema_version: 'affect-cognition-rationale-vocabulary-language-audit-v0', counts: {}, completion_cells: [],
...
const factualAudit = {
  schema_version: 'affect-cognition-rationale-vocabulary-factual-authority-audit-v0', claims: 0, subject_state_fact_cells: 0,
...
const handleAudit = {
  schema_version: 'affect-cognition-rationale-vocabulary-handle-binding-audit-v0',
...
write('clarification-audit.json', { schema_version: 'affect-cognition-rationale-vocabulary-clarification-audit-v0', false_necessity: falseClarify, pass: falseClarify === 0 });
const leakageViolations = rows.filter((row) => row.language_leakage?.ok === false || row.request_attestation?.ok === false).length;
write('condition-leakage.json', { schema_version: 'affect-cognition-rationale-vocabulary-condition-leakage-v0', rows: rows.length, violations: leakageViolations, pass: leakageViolations === 0 });
...
const falsification = {
  schema_version: 'affect-cognition-rationale-vocabulary-family-d-falsification-v0', threshold: FALSIFICATION,
...
const verdict = {
  schema_version: 'affect-cognition-rationale-vocabulary-qualification-verdict-v0',
