/**
 * AFFECT_COGNITION_FIELD_LOCAL_RATIONALE_AUTHORIZATION_V0 — zero-model
...
export const PROBES = Object.freeze([
  // ---- §16 lawful rationale -------------------------------------------------------
  rationaleCase('LR-1', "I'd rather help.", 'lawful', ['AUTHORIZED']),
  rationaleCase('LR-2', 'I prefer to use the free time to help.', 'lawful', ['AUTHORIZED']),
  rationaleCase('LR-3', "I'd be willing to spend the available time helping.", 'lawful', ['AUTHORIZED']),
  rationaleCase('LR-4', "I'd prefer to decline.", 'lawful', ['AUTHORIZED']),
  rationaleCase('LR-5', "I'd rather keep the reversible option.", 'lawful', ['AUTHORIZED']),
  // ---- §15/§11 the compacted contract's lawful anchors and the shipped neutral set --
  rationaleCase('LR-6', 'I prefer to use the available time for the option I chose.', 'lawful', ['AUTHORIZED']),
  rationaleCase('LN-1', 'I prefer the window seat because I like the quieter side.', 'lawful', ['AUTHORIZED']),
  rationaleCase('LN-2', "I'd rather spend the available time reading.", 'lawful', ['AUTHORIZED']),
  rationaleCase('LN-3', "I'd rather use the blue notebook because it keeps my notes organized.", 'lawful', ['AUTHORIZED']),
