...
const nullAnalysis = { schema_version: 'affect-cognition-field-local-rationale-authorization-null-analysis-v0', per_scenario: {}, aggregate: { correct: 0, required: 0 }, pass: false };
...
const mixedAnalysis = { schema_version: 'affect-cognition-field-local-rationale-authorization-mixed-analysis-v0', aggregate: { facts_correct: 0, selected: 0, preserved: 0, unsupported: 0, self_state: 0, total: 0 }, separation: {}, material_scenarios: [], pass: false };
...
const relevantAnalysis = { schema_version: 'affect-cognition-field-local-rationale-authorization-relevant-analysis-v0', per_scenario: {}, material_scenarios: [], pass: false };
...
const historicalAnalysis = { schema_version: 'affect-cognition-field-local-rationale-authorization-historical-analysis-v0', diagnostic_only: true, claim: 'no causal claim is made from S cells', per_scenario: {} };
...
write('verdict.json', { schema_version: 'affect-cognition-field-local-rationale-authorization-formal-verdict-v0', rows: rows.length, flags, principal_verdict: principal });
