/**
 * AFFECT_COGNITION_CONTRACT_COMPACTION_..._V0 — qualification analysis (deterministic, zero model
...
const applicabilityAudit = {
  schema_version: 'affect-cognition-contract-compaction-applicability-audit-v0', per_scenario: {},
...
const rationaleAudit = {
  schema_version: 'affect-cognition-contract-compaction-rationale-audit-v0',
...
const stanceAudit = {
  schema_version: 'affect-cognition-contract-compaction-stance-grounding-audit-v0',
...
// ---- language fidelity ----------------------------------------------------------
const languageAudit = {
  schema_version: 'affect-cognition-contract-compaction-language-audit-v0', counts: {}, completion_cells: [],
...
const factualAudit = {
  schema_version: 'affect-cognition-contract-compaction-factual-authority-audit-v0', claims: 0, subject_state_fact_cells: 0,
...
const handleAudit = {
  schema_version: 'affect-cognition-contract-compaction-handle-binding-audit-v0',
...
write('clarification-audit.json', { schema_version: 'affect-cognition-contract-compaction-clarification-audit-v0', false_necessity: falseClarify, pass: falseClarify === 0 });
const leakageViolations = rows.filter((row) => row.language_leakage?.ok === false || row.request_attestation?.ok === false).length;
write('condition-leakage.json', { schema_version: 'affect-cognition-contract-compaction-condition-leakage-v0', rows: rows.length, violations: leakageViolations, pass: leakageViolations === 0 });
...
const falsification = {
  schema_version: 'affect-cognition-contract-compaction-family-d-falsification-v0', threshold: FALSIFICATION,
...
const verdict = {
  schema_version: 'affect-cognition-contract-compaction-qualification-verdict-v0',
