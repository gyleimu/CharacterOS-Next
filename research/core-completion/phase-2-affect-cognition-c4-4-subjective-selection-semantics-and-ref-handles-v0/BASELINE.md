# AFFECT_COGNITION_C4_4_CONTRACT_LEGIBILITY_AND_GROUNDING_V0 — BASELINE
...
| --- | --- | --- |
| Cognition protocol | `conversation-cognition-proposal-v6` (unchanged) | `proposal_v5_schema_sha256` |
| Cognition prompt | C4.2 policy **plus** C4.3 rule 2a (citation binding) | `cognition_prompt_sha256: sha256:cbde0b7f…` |
| Language input | `language-realization-input-v7` (unchanged) | — |
