/**
 * AFFECT_COGNITION_C4_4_SELECTION_APPLICABILITY_AND_SUBJECTIVE_BASIS_V0 —
...
let principal;
if (flags.protocol_failures > rows.length * 0.1) principal = 'AFFECT_COGNITION_C4_4_IMPLEMENTATION_FAILED';
