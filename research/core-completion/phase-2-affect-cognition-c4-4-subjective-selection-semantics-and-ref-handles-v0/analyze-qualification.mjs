...
const factualAudit = {
  schema_version: 'affect-cognition-c4-4-factual-authority-audit-v0', claims: 0, subject_state_fact_cells: 0,
...
let principal;
if (!flags.implementation_intact) principal = 'AFFECT_COGNITION_C4_4_IMPLEMENTATION_FAILED';
...
const verdict = {
  schema_version: 'affect-cognition-c4-4-qualification-verdict-v0',
